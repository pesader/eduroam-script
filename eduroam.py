...
"""
 * **************************************************************************
 * Contributions to this work were made on behalf of the GÃ‰ANT project,
 * a project that has received funding from the European Unionâ€™s Framework
 ...
 * by a member of the GÃ‰ANT project.
 * GÃ‰ANT Vereniging (Association) is registered with the Chamber of
 * Commerce in Amsterdam with registration number 40535155 and operates
 * in the UK as a branch of GÃ‰ANT Vereniging.
 * 
...
Authors:
    ...
    MichaÅ‚ Gasewicz <genn@umk.pl> (Network Manager support)
...
Messages.passwords_differ = "as passwords nÃ£o coincidem"
Messages.installation_finished = "InstalaÃ§Ã£o realizada com sucesso"
Messages.cat_dir_exisits = "A diretoria {} existe; alguns ficheiros " \
    "podem ser sobrepostos"
Messages.cont = "Continuar?"
Messages.nm_not_supported = "Esta versÃ£o do NetworkManager nÃ£o Ã© " \
    "suportada"
Messages.cert_error = "O ficheiro de certificado nÃ£o foi encontrado, " \
    "parece ser um erro do CAT"
Messages.unknown_version = "VersÃ£o desconhecida"
Messages.dbus_error = "Problema de ligaÃ§Ã£o DBus, um sudo pode " \
    "ajudar"
Messages.yes = "S"
Messages.no = "N"
...
Messages.save_wpa_conf = "A configuraÃ§Ã£o do NetworkManager falhou, " \
    "mas podemos criar um ficheiro de configuraÃ§Ã£o wpa_supplicant se " \
    "pretender. Tenha em atenÃ§Ã£o que a sua palavra passe de ligaÃ§Ã£o " \
    "irÃ¡ ser guardada neste ficheiro como texto visÃ­vel."
...
Messages.wrong_realm_suffix = "Erro: o seu nome de utilizador tem de " \
    "estar na forma 'xxx@institutionID' e terminar com '{}'.Â Por favor " \
    "coloque o nome de utilizador no formato correto."
Messages.user_cert_missing = "ficheiro do certificado pessoal nÃ£o " \
    "encontrado"
Config.instname = "UNICAMP - Universidade Estadual de Campinas"
Config.profilename = "eduroam"
Config.url = "http://www.ccuec.unicamp.br/ccuec/redesemfio_eduroam"
Config.email = "sauccuec@unicamp.br"
Config.title = "eduroam CAT"
Config.server_match = "unicamp.br"
Config.eap_outer = "TTLS"
Config.eap_inner = "PAP"
Config.init_info = "O instalador foi preparado para {0}\n\nMais " \
    "informaÃ§Ãµes e comentÃ¡rios:\n\nEMAIL: {1}\nWWW: {2}\n\nInstalador " \
...
Config.user_realm = "unicamp.br"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius1.unicamp.br', 'DNS:radius2.unicamp.br']
